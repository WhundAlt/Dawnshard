<script>
	import story from '$lib/assets/story.webp';
	import * as Card from '$shadcn/components/ui/card';
</script>

<div
	id="banner"
	class="background-image grid grid-cols-12 gap-4"
	style:background-image="url({story})"
>
	<Card.Root class="sm:col-span-12 lg:col-span-7">
		<Card.Header>
